...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game(name="Power BY Velocity Downer"))
...
bot.run('MTI2MDUwMzA3NDA3ODcyNDEyNw.G97nI5.iSJW-b_dk_udJi73TdrcenwInFzoQA9UdzSSb8')
